...
public class LangConfig extends BaseConfig {
    ...
    @Path("general.offline-player")
    public String OFFLINE_PLAYER = "&6&lECONOMY &8| &c{target} is not online or the name you typed is wrong";
    ...
    public String MONEY_RECEIVED = "&6&lECONOMY &8| &fYou received &e{amount}{symbol} from {sender}";
    ...
    @Path("eco.set.sender")
    public String ECO_SET_SENDER = "&6&lECONOMY &8| &fYou set &e{target}&f's balance to {amount}{symbol}";
